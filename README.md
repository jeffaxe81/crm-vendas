...
> **⚠️ Decisão de arquitetura — [ADR-0002](./docs/decisions/ADR-0002-stack-principal-typescript.md) (23/09/2026):**
> a stack principal é o **monorepositório TypeScript** (`apps/api` NestJS + Prisma + PostgreSQL/RLS, `apps/web` Next.js).
> Onde este documento cita FastAPI como API do CRM, leia NestJS. O `backend/` FastAPI fica reservado ao serviço de ML do Ciclo 6.
...
_For detailed project status, see [`PROJECT_SUMMARY_DOCUMENTATION_INDEX.md`](./PROJECT_SUMMARY_DOCUMENTATION_INDEX.md)_
